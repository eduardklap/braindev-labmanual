...
## Version control
Version control is something that is not often used yet, but extremely important when managing a lot of data. Keeping track of the different versions of your files allows you to see:

- Which version is the most recent
- Which version is the untouched, "raw" version (very important for raw data)
- What happened between the raw and final versions
...
![The Research Data lifecycle (source: UK data archive]('figures/Research_Data_Lifecycle_.png')
